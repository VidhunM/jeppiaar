  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      console.log('Initializing Razorpay with:', {
        ...
        keyPrefix: razorpayKeyId.substring(0, 8),
        amount: feeInr * 100,
        currency: 'INR'
      });
      ...
      const options = {
        ...
        // order_id: null, // Removed null order_id to allow direct payment if supported, or fix 401 issues
            ...
            <article className="apply-document" aria-label="Online application form">
              ...
              <form className="apply-form" onSubmit={handleSubmit}>
                ...
                {!submitted ? (
                  ...
                  <div className="apply-payment" style={{ textAlign: 'center', padding: '3rem 1rem' }}>
                    <h3 style={{ color: '#28a745', fontSize: '1.5rem', marginBottom: '1rem', lineHeight: '1.4' }}>
                      Thank you for your registration our team will contact you
                    </h3>
                    <p style={{ color: '#666', fontSize: '1.1rem' }}>Application ID: <strong>{applicationId}</strong></p>
                  </div>
                ) : (
                    ...
                    {hasRazorpay ? (
                      ...
                      <div>
                        ...
                        <button
                          ...
                          style={{ marginTop: '1rem', backgroundColor: '#28a745', border: 'none' }}
                          onClick={() => {
                            setPaymentFinished(true);
