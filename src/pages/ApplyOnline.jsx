...
const DEFAULT_SCRIPT_URL =
  'https://script.google.com/macros/s/AKfycbw94ZBBLU5OIcbG_Ydo-Qizu-JiSmA6x0JwNmtHTcQ9-L2onyqDhwkACsVGfXgxI708/exec';
                  ...
                  <div className="apply-payment">
                    ...
                    {paymentHref ? (
                      ...
                      <div className="apply-payment-warning">
                        Payment gateway is not configured yet. Set <code>VITE_APPLICATION_PAYMENT_URL</code> and redeploy.
                      </div>
                    )}
                  </div>
                )}
